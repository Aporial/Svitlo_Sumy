...
def start_parsing_today():
    ...
    def cherg_2():
        ...
        def update_database(begin_hour, end_hour):
            ...
            day_num_key = f'{day_prefix}_{new_index}'
            print(day_num_key)
            main_database["2_cherg"][day_num_key] = f"{begin_hour}-{end_hour}"
            save_last_index(new_index)
            with open(file, 'w', encoding='utf-8') as new_file:
                json.dump(main_database, new_file,
                          ensure_ascii=False, indent=4)
    ...
    def cherg_3():
        ...
        def update_database(begin_hour, end_hour):
            ...
            day_num_key = f'{day_prefix}_{new_index}'
            print(day_num_key)
            main_database["3_cherg"][day_num_key] = f"{begin_hour}-{end_hour}"
            save_last_index(new_index)
            with open(file, 'w', encoding='utf-8') as new_file:
                json.dump(main_database, new_file,
                          ensure_ascii=False, indent=4)
    ...
    def cherg_4():
        ...
        def update_database(begin_hour, end_hour):
            ...
            day_num_key = f'{day_prefix}_{new_index}'
            print(day_num_key)
            main_database["4_cherg"][day_num_key] = f"{begin_hour}-{end_hour}"
            save_last_index(new_index)
            with open(file, 'w', encoding='utf-8') as new_file:
                json.dump(main_database, new_file,
                          ensure_ascii=False, indent=4)
    ...
    def cherg_5():
        ...
        def update_database(begin_hour, end_hour):
            ...
            day_num_key = f'{day_prefix}_{new_index}'
            print(day_num_key)
            main_database["5_cherg"][day_num_key] = f"{begin_hour}-{end_hour}"
            save_last_index(new_index)
            with open(file, 'w', encoding='utf-8') as new_file:
                json.dump(main_database, new_file,
                          ensure_ascii=False, indent=4)
    ...
    def cherg_6():
        ...
        def update_database(begin_hour, end_hour):
            ...
            day_num_key = f'{day_prefix}_{new_index}'
            print(day_num_key)
            main_database["6_cherg"][day_num_key] = f"{begin_hour}-{end_hour}"
            save_last_index(new_index)
            with open(file, 'w', encoding='utf-8') as new_file:
                json.dump(main_database, new_file,
                          ensure_ascii=False, indent=4)
