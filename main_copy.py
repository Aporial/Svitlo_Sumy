    ...
    zbir = ft.AlertDialog(
        ...
        content=ft.Column(
            ...
            controls=[
                ...
                ft.Text(
                    value="""Всім доброго дня! Я розробник застосунку "Світло Суми". На жаль, мій друг дитинства, Кравцов Максим Миколайович, отримав тяжке поранення на війні. Він був штурмовиком на Донецькому напрямку (на "нулі"). Під час наступу ворогів він отримав наскрізне осколкове поранення. Осколок влетів у нижню частину спини та вилетів зі стегна. Отримано масивний дефект м'яких тканин лівої сідничної ділянки, підшкірну емфізему та уламковий перелом сідничної кістки ліворуч.

Тому я організовую збір коштів на реабілітацію. Я залишу нижче банку Monobank, яка буде доступна 7 днів. Після цього я закрию збір і перекину гроші Максиму.

Якщо хтось може допомогти - прошу підтримати. Кожна гривня важлива!

Збір більше не буде з'являтися під час запуску. Але я залишив посилання на збір у вкладці "Інформація".
