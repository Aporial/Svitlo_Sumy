    ...
    zbir = ft.AlertDialog(
        ...
        content=ft.Column(
            ...
            controls=[
                ...
                ft.Text(
                    value="""Всім Добрий день. На жаль, мій друг дитинства, Кравцов Максим Миколайович, отримав тяжке поранення на війні. Він був штурмовиком на Донецькому напрямку(на нулі). Під час наступу ворогів, він отримав наскрізне осколкове поранення. Осколок влетів в низ спини та вилетів зі стегна. Отримано масивний дефект м'ягких тканин лівої сідничної ділянки, підшкірна емфізема та уламковий перелом сідничної кістки ліворуч. Фотографію прикріпив нижче, але попереджаю там 18+. 
Тому, я роблю збір на реабілітацію. Я нижче залишу банку монобанку, яка буде доступна 7 днів. Після чого я її закриваю, та перекидаю гроші Максиму(також я покажу скріншот переказу грошей). 
Також, залишаю номер Максима:  +380508623971
Якщо хтось може - прошу допомогти. Кожна гривня важлива!
Монобанк: На реабілітацію (https://send.monobank.ua/jar/6aCSwXTPgK)
Дякую за увагу!"""
                )
            ]
        )
